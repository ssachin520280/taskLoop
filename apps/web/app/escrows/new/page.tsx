  ...
  return (
    <PageShell>
      <PageHeader
        ...
        description="Create a real milestone escrow through the configured factory contract."
      />
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_24rem]">
        ...
        <Card className="h-fit bg-[#fff7df]">
          <CardContent>
            <p className="text-xs font-black uppercase tracking-[0.2em] text-[var(--brand-strong)]">Contract checklist</p>
            <h2 className="mt-3 text-2xl font-black text-[var(--ink)]">Before submission</h2>
